    ...
    $.formBubbleSort = function(el, options) {
        ...
        base.sortingAlgorithm = function(event) {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  console.log("SORT isSorted :::: " + base.isSorted());
        ...
        base.reset = function(event) {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $("#sorting-algorithm").html("Click step");
        ...
        base.play = function(event) {
            $.ajax({
                ...
                beforeSend: function(jqXHR, settings) {
                    $("#sorting-algorithm").html('Loading...');
                    $("#message").html('<img height="20px" src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/cd514331234507.564a1d2324e4e.gif">WORKING...');
                },
                success: function(data, textStatus, jqXHR) {
                    ...
                    if (base.isSorted()) {
                        setTimeout(function(){ base.play(event); }, 700);
                    } else {
