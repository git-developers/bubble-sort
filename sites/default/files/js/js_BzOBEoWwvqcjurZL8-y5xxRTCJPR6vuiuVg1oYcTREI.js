        ...
        base.reset = function(event) {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $("#sorting-algorithm").html('<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Bubblesort-edited-color.svg/1200px-Bubblesort-edited-color.svg.png" class="thumbnail">');
