...
class LocaleConfigTranslationTest extends BrowserTestBase {
  ...
  protected function assertNodeConfig($required, $optional) {
    ...
    $string = $this->storage->findString(['source' => '5555 No front page content has been created yet.<br/>Follow the <a target="_blank" href="https://www.drupal.org/docs/user_guide/en/index.html">User Guide</a> to start building your site.', 'context' => '', 'type' => 'configuration']);
    if ($optional) {
